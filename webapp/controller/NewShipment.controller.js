sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.prodeing.controller.NewShipment", {
		handleRouteMatched: function(oEvent) {
			var sAppId = "App66303c034bb5bea343f95773";

			var oParams = {
				"expand": "Supplier,Supply"
			};
			...
			if (!this.sContext) {
				this.sContext = "ShipmentSet('PA00001')";
			}
		...
		onInit: function() {
			...
			this.oRouter.getTarget("NewShipment").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "Fiori_ObjectPage_ObjectPage_0-sections-Fiori_ObjectPage_Section-1714876312030-sectionContent-Fiori_ObjectPage_Form-1714876330662-formGroups-Fiori_ObjectPage_FormGroup-1-formElements-Fiori_ObjectPage_CustomFormElement-1714876361847-rjn94ormiq10hzz5cjbupzt83_S3-control-sap_m_ComboBox-1716425313655",
				"groups": ["items"]
			}, {
				"controlId": "Fiori_ObjectPage_ObjectPage_0-sections-Fiori_ObjectPage_Section-1714876312030-sectionContent-Fiori_ObjectPage_Form-1714876330662-formGroups-Fiori_ObjectPage_FormGroup-1-rjn94ormiq10hzz5cjbupzt83_S3-formElements-Fiori_ObjectPage_CustomFormElement-1716444730622-control-sap_m_ComboBox-1716444748106",
				"groups": ["items"]
			}];
