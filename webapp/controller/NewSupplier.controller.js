sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.prodeing.controller.NewSupplier", {
		handleRouteMatched: function(oEvent) {
			...
			if (!this.sContext) {
				this.sContext = "SupplierSet('CO00001')";
			}
		...
		onInit: function() {
			...
			this.oRouter.getTarget("NewSupplier").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
