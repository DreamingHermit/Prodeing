sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.prodeing.controller.EditItem", {
		...
		onInit: function() {
			...
			this.oRouter.getTarget("EditItem").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "Fiori_ObjectPage_ObjectPage_0-sections-Fiori_ObjectPage_Section-1714876312030-sectionContent-Fiori_ObjectPage_Form-1714876330662-formGroups-Fiori_ObjectPage_FormGroup-1-formElements-Fiori_ObjectPage_CustomFormElement-1714876437730-control-sap_m_ComboBox-1714876463860",
				"groups": ["items"]
			}];
