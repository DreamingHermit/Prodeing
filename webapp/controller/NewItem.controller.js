sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.prodeing.controller.NewItem", {
		handleRouteMatched: function(oEvent) {
			...
			if (!this.sContext) {
				this.sContext = "SupplySet('SU00001')";
			}
		...
		onInit: function() {
			...
			this.oRouter.getTarget("NewItem").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
