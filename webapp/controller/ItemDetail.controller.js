sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.prodeing.controller.ItemDetail", {
		...
		_onFioriObjectPageActionButtonPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("EditItem", oBindingContext, fnResolve, "");
		...
		_onFioriObjectPageActionButtonPress1: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("ItemRemoved", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		onInit: function() {
			...
			this.oRouter.getTarget("ItemDetail").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "Fiori_ObjectPage_ObjectPage_0-sections-Fiori_ObjectPage_Section-1716444940220-sectionContent-Fiori_ObjectPage_Table-1716444960468",
				"groups": ["items"]
			}];
